                    ...
                    <div class="card">
                        <div class="card-body">
                            <div class="form-group">
                                ...
                                <?= Form::input('options:Draft|Publish', "posts[status]", ['class'=>"form-control","placeholder"=>_ucwords(__('status')),"value"=>$old['status']??'']) ?>
                            </div>
                            <div class="form-group">
                                ...
                                <div class="selectgroup selectgroup-pills">
                                    ...
                                    <label class="selectgroup-item">
                                        <input type="checkbox" name="categories[]" value="<?=$category->id?>" class="selectgroup-input">
                            ...
                            <div class="form-group">
                                ...
                                <input type="hidden" name="posts[thumb_url]" id="thumb_url">
                                <div class="img-preview d-none" style="position:relative">
                                    ...
                                    <img src="" alt="" class="thumb-img" style="width:100%;height:150px;object-fit:cover;">
                                </div>
